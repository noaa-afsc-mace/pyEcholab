...
class Ui_imageAdjustmentsDlg(object):
    def setupUi(self, imageAdjustmentsDlg):
        ...
        self.gbBrightnessContrast = QtWidgets.QGroupBox(parent=imageAdjustmentsDlg)
        font = QtGui.QFont()
        ...
        self.label_8 = QtWidgets.QLabel(parent=self.gbBrightnessContrast)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.brightnessSlider = QtWidgets.QSlider(parent=self.gbBrightnessContrast)
        self.brightnessSlider.setMinimum(-100)
        self.brightnessSlider.setMaximum(100)
        self.brightnessSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.brightnessSlider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksAbove)
        self.brightnessSlider.setTickInterval(50)
        self.brightnessSlider.setObjectName("brightnessSlider")
        self.verticalLayout_4.addWidget(self.brightnessSlider)
        self.bcAutomatic = QtWidgets.QRadioButton(parent=self.gbBrightnessContrast)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gbAutoBC = QtWidgets.QGroupBox(parent=self.gbBrightnessContrast)
        ...
        self.label_10 = QtWidgets.QLabel(parent=self.gbAutoBC)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.bcClipLimit = QtWidgets.QSlider(parent=self.gbAutoBC)
        self.bcClipLimit.setMinimum(5)
        self.bcClipLimit.setMaximum(50)
        self.bcClipLimit.setProperty("value", 17)
        self.bcClipLimit.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.bcClipLimit.setTickPosition(QtWidgets.QSlider.TickPosition.TicksAbove)
        self.bcClipLimit.setTickInterval(5)
        self.bcClipLimit.setObjectName("bcClipLimit")
        self.formLayout_4.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.bcClipLimit)
        self.verticalLayout_4.addWidget(self.gbAutoBC)
        self.bcManual = QtWidgets.QRadioButton(parent=self.gbBrightnessContrast)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gbManualBC = QtWidgets.QGroupBox(parent=self.gbBrightnessContrast)
        ...
        self.label_7 = QtWidgets.QLabel(parent=self.gbManualBC)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.contrastSlider = QtWidgets.QSlider(parent=self.gbManualBC)
        ...
        self.pbBCReset = QtWidgets.QPushButton(parent=self.gbBrightnessContrast)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gbColorCorrection = QtWidgets.QGroupBox(parent=imageAdjustmentsDlg)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.cbAWB = QtWidgets.QCheckBox(parent=self.gbColorCorrection)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.ccManual = QtWidgets.QRadioButton(parent=self.gbColorCorrection)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.gbManualCC = QtWidgets.QGroupBox(parent=self.gbColorCorrection)
        ...
        self.label = QtWidgets.QLabel(parent=self.gbManualCC)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.redSlider = QtWidgets.QSlider(parent=self.gbManualCC)
        self.redSlider.setMinimum(-50)
        self.redSlider.setMaximum(50)
        self.redSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.redSlider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksAbove)
        self.redSlider.setTickInterval(10)
        self.redSlider.setObjectName("redSlider")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.redSlider)
        self.label_2 = QtWidgets.QLabel(parent=self.gbManualCC)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.greenSlider = QtWidgets.QSlider(parent=self.gbManualCC)
        ...
        self.greenSlider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksAbove)
        self.greenSlider.setTickInterval(10)
        self.greenSlider.setObjectName("greenSlider")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.greenSlider)
        self.label_3 = QtWidgets.QLabel(parent=self.gbManualCC)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.blueSlider = QtWidgets.QSlider(parent=self.gbManualCC)
        ...
        self.blueSlider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksAbove)
        self.blueSlider.setTickInterval(10)
        self.blueSlider.setObjectName("blueSlider")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.blueSlider)
        ...
        self.pbColorReset = QtWidgets.QPushButton(parent=self.gbColorCorrection)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.pbApply = QtWidgets.QPushButton(parent=imageAdjustmentsDlg)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pbApply.setFont(font)
        self.pbApply.setObjectName("pbApply")
        self.horizontalLayout_2.addWidget(self.pbApply)
        self.pbCancel = QtWidgets.QPushButton(parent=imageAdjustmentsDlg)
        font = QtGui.QFont()
        font.setPointSize(10)
